    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-2">אין לידים עדיין</h1>
      ...
      <div className="container max-w-4xl">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full rounded-lg border bg-card px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-all"
          />
        </div>
        ...
        <div className="space-y-3">
          {filteredLeads.map((lead, index) => {
            ...
            return (
              <div
                key={originalIndex}
                className="bg-card rounded-xl border shadow-sm overflow-hidden transition-shadow hover:shadow-md"
              >
                {/* Lead header */}
                <div
                ...
                >
                  <div className="flex items-center gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="font-semibold truncate">{lead.fullName}</p>
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    {result && (
                      <span className="text-xs px-2.5 py-1 rounded-full bg-muted font-medium hidden sm:inline-block">
                        {result.willType}
                      </span>
                    )}
                ...
                {/* Expanded details */}
                {isExpanded && (
                  <div className="border-t px-5 py-5 bg-muted/30 space-y-5 animate-fade-in">
                    {/* Result summary */}
                    {result && (
