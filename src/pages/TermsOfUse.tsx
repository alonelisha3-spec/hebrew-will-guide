        ...
        <div className="container max-w-3xl mx-auto" dir="rtl">
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p>
                המערכת מציעה כלי עזר ראשוני ליצירת טיוטת צוואה או לבדיקה ראשונית של צוואה קיימת, על בסיס תשובות המשתמש. התוצאות המופקות הן כלליות, ראשוניות ואוטומטיות בלבד.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                השימוש במערכת <strong className="text-foreground">אינו מהווה ייעוץ משפטי</strong>, אינו יוצר יחסי עורך דין–לקוח, ואינו מחליף פגישת ייעוץ אישית עם עורך דין. הטיוטות, התוצאות והניתוחים המוצגים אינם מהווים צוואה תקפה לפי חוק הירושה, התשכ"ה-1965, ואין להסתמך עליהם ככאלה.
              </p>
            </section>
