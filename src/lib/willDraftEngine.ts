...
function buildDraftText(a: Record<string, string>, willType: WillDraftData["willType"]): string {
  ...
  lines.push("────────────────────────────────────────");
  lines.push(
    "הערה חשובה: מסמך זה הוא טיוטה ראשונית וכללית בלבד. הוא אינו מהווה צוואה תקפה, אינו מהווה ייעוץ משפטי, ואינו מחליף התאמה פרטנית, השלמת פרטים ובדיקה משפטית לפני חתימה."
  );
